...
class SemanticNetworkQueries:
    ...
    def get_semantic_type_by_name(self, sty_rl: str, all_rows=True) -> List[Any]:
    ...
    def get_last_parents_semantic_type_by_name(self, sty_rl: str, all_rows=True) -> List[Any]:
    ...
    def get_all_parents_semantic_type_by_name(self, sty_rl: str, all_rows=True) -> List[Any]:
    ...
    def get_childen_semantic_type_by_name(self, sty_rl: str, all_rows=True) -> List[Any]:
    ...
    def get_all_children_semantic_type_by_name(self, sty_rl: str, all_rows=True) -> List[Any]:
    ...
    def get_siblings_semantic_type_by_name(self, sty_rl: str, all_rows=True) -> List[Any]:
    ...
    def get_relationships_semantic_type_by_name(self, sty_rl: str, all_rows=True) -> List[Any]:
    ...
    def get_all_relationships_semantic_type_by_name(self, sty_rl: str, all_rows=True) -> List[Any]:
    ...
    def get_semantic_type_by_tui(self, tui: str, all_rows=True) -> List[Any]:
    ...
    def get_last_parents_semantic_type_by_tui(self, tui: str, all_rows=True) -> List[Any]:
    ...
    def get_all_parents_semantic_type_by_tui(self, tui: str, all_rows=True) -> List[Any]:
    ...
    def get_childen_semantic_type_by_tui(self, tui: str, all_rows=True) -> List[Any]:
    ...
    def get_all_children_semantic_type_by_tui(self, tui: str, all_rows=True) -> List[Any]:
    ...
    def get_siblings_semantic_type_by_tui(self, tui: str, all_rows=True) -> List[Any]:
    ...
    def get_relationships_semantic_type_by_tui(self, tui: str, all_rows=True) -> List[Any]:
    ...
    def get_all_relationships_semantic_type_by_tui(self, tui: str, all_rows=True) -> List[Any]:
    ...
    def get_all_tui(self, all_rows=True) -> List[Any]:
        """Get all TUI
    ...
    def get_all_gui(self, all_rows=True) -> List[Any]:
        """Get all TUI
